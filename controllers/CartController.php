     ...
     * @return  false json  информация об операции(успех, кол-во элементов в корзине)
     */
     ...
     * @return void json информация об операции (успех, кол-во элементов в корзине)
     *
     */
    ...
    function orderAction($smarty)
    {
        ...
        // поолучаем из массива $_POST количество покупаемых товаров
        $itemsCnt = array();
        ...
        // получаемый  массив покупаемых товаров  помещаем в сессионную переменную
     ...
     *
     * @param array  $_SESSION['saleCart']  масссив покупаемых продуктов
     * @return void  json информация о результате выполнения
     */
